...
household_debt <- read.csv(
        "C:\\Users\\Deka\\Desktop\\DataAnalysis22\\Portfolio\\Total_household_debt_Sept2019_to_Aug2022.csv",
        stringsAsFactors = FALSE)

cpi_data <-read.csv(
        "C:\\Users\\Deka\\Desktop\\DataAnalysis22\\Portfolio\\CPI_Data_Canada_Sept2019_to_Aug_2022.csv",
        stringsAsFactors = FALSE)
  
cpi_1960_to_2022 <- read.csv(
  "C:\\Users\\Deka\\Desktop\\DataAnalysis22\\Portfolio\\CPI_data_1960_to_2022.csv",
  stringsAsFactors = FALSE)

bank_of_canada_rates <-read.csv(
        "C:\\Users\\Deka\\Desktop\\DataAnalysis22\\Portfolio\\Bank_of_Canada_rates_Sept2019_to_Aug2022.csv",
        stringsAsFactors = FALSE)
...
gdp %>%
  ...
  labs(
    y="Changes in CPI (%)",
    x="time",
    title ="Yearly Percent increases in CPI 1960 to 2022"
  )
...
bank_of_canada_rates %>%
  ...
  labs(
    ...
    x="time",
    title ="Bank rates & monthly inflation rates before and during COVID-19 Pandemic"
  )
...
#Quebec DPI rates
  ...
  labs(
    ...
    x="time",
    title ="Inflation rates before and during COVID-19 Pandemic"
  ) 
